...
GRANT INSERT, SELECT, UPDATE ON acta_fiscalizacion TO kamayuk_app;
GRANT SELECT ON acta_fiscalizacion TO kamayuk_readonly;
GRANT INSERT, SELECT ON actividad_economica TO kamayuk_app;
GRANT SELECT ON actividad_economica TO kamayuk_readonly;
GRANT INSERT, SELECT ON acto_coactivo TO kamayuk_app;
GRANT SELECT ON acto_coactivo TO kamayuk_readonly;
GRANT INSERT, SELECT ON anuncio TO kamayuk_app;
GRANT SELECT ON anuncio TO kamayuk_readonly;
GRANT INSERT, SELECT, UPDATE ON anuncio_correlativo TO kamayuk_app;
GRANT SELECT ON anuncio_correlativo TO kamayuk_readonly;
GRANT INSERT, SELECT ON anuncio_movimiento TO kamayuk_app;
GRANT SELECT ON anuncio_movimiento TO kamayuk_readonly;
...
GRANT INSERT, SELECT, UPDATE ON beneficio TO kamayuk_app;
GRANT SELECT ON beneficio TO kamayuk_readonly;
...
GRANT INSERT, SELECT ON certificado TO kamayuk_app;
GRANT SELECT ON certificado TO kamayuk_readonly;
GRANT INSERT, SELECT, UPDATE ON certificado_correlativo TO kamayuk_app;
GRANT SELECT ON certificado_correlativo TO kamayuk_readonly;
...
GRANT INSERT, SELECT, UPDATE ON ciiu TO kamayuk_app;
GRANT SELECT ON ciiu TO kamayuk_readonly;
GRANT INSERT, SELECT, UPDATE ON codigo_infraccion TO kamayuk_app;
GRANT SELECT ON codigo_infraccion TO kamayuk_readonly;
...
GRANT INSERT, SELECT ON constancia_libre TO kamayuk_app;
GRANT SELECT ON constancia_libre TO kamayuk_readonly;
GRANT INSERT, SELECT, UPDATE ON construccion TO kamayuk_app;
GRANT SELECT ON construccion TO kamayuk_readonly;
GRANT INSERT, SELECT, UPDATE ON contacto TO kamayuk_app;
GRANT SELECT ON contacto TO kamayuk_readonly;
GRANT INSERT, SELECT, UPDATE ON contribuyente TO kamayuk_app;
GRANT SELECT ON contribuyente TO kamayuk_readonly;
GRANT INSERT, SELECT ON convenio TO kamayuk_app;
GRANT SELECT ON convenio TO kamayuk_readonly;
GRANT INSERT, SELECT, UPDATE ON convenio_correlativo TO kamayuk_app;
GRANT SELECT ON convenio_correlativo TO kamayuk_readonly;
GRANT INSERT, SELECT ON convenio_cuota TO kamayuk_app;
GRANT SELECT ON convenio_cuota TO kamayuk_readonly;
GRANT INSERT, SELECT ON convenio_deuda TO kamayuk_app;
GRANT SELECT ON convenio_deuda TO kamayuk_readonly;
GRANT INSERT, SELECT ON convenio_movimiento TO kamayuk_app;
GRANT SELECT ON convenio_movimiento TO kamayuk_readonly;
GRANT INSERT, SELECT ON corrida_predial TO kamayuk_app;
GRANT SELECT ON corrida_predial TO kamayuk_readonly;
GRANT INSERT, SELECT ON corrida_predial_observado TO kamayuk_app;
GRANT SELECT ON corrida_predial_observado TO kamayuk_readonly;
GRANT INSERT, SELECT ON costa_obligacion TO kamayuk_app;
GRANT SELECT ON costa_obligacion TO kamayuk_readonly;
GRANT INSERT, SELECT ON costa_procesal TO kamayuk_app;
GRANT SELECT ON costa_procesal TO kamayuk_readonly;
GRANT INSERT, SELECT ON cuenta_corriente_asiento TO kamayuk_app;
GRANT SELECT ON cuenta_corriente_asiento TO kamayuk_readonly;
GRANT INSERT, SELECT ON declaracion_jurada TO kamayuk_app;
GRANT SELECT ON declaracion_jurada TO kamayuk_readonly;
GRANT UPDATE (estado) ON declaracion_jurada TO kamayuk_app;
...
GRANT INSERT, SELECT ON descargo TO kamayuk_app;
GRANT SELECT ON descargo TO kamayuk_readonly;
GRANT INSERT, SELECT, UPDATE ON determinacion TO kamayuk_app;
GRANT SELECT ON determinacion TO kamayuk_readonly;
GRANT INSERT, SELECT ON determinacion_arbitrio TO kamayuk_app;
GRANT SELECT ON determinacion_arbitrio TO kamayuk_readonly;
GRANT INSERT, SELECT ON determinacion_predio_detalle TO kamayuk_app;
GRANT SELECT ON determinacion_predio_detalle TO kamayuk_readonly;
GRANT INSERT, SELECT, UPDATE ON dj_correlativo TO kamayuk_app;
GRANT SELECT ON dj_correlativo TO kamayuk_readonly;
GRANT INSERT, SELECT, UPDATE ON documento_emitido TO kamayuk_app;
GRANT SELECT ON documento_emitido TO kamayuk_readonly;
GRANT INSERT, SELECT, UPDATE ON domicilio TO kamayuk_app;
GRANT SELECT ON domicilio TO kamayuk_readonly;
GRANT INSERT, SELECT, UPDATE ON edificacion_correlativo TO kamayuk_app;
GRANT SELECT ON edificacion_correlativo TO kamayuk_readonly;
GRANT INSERT, SELECT ON edificacion_estructura TO kamayuk_app;
GRANT SELECT ON edificacion_estructura TO kamayuk_readonly;
GRANT INSERT, SELECT ON edificacion_movimiento TO kamayuk_app;
GRANT SELECT ON edificacion_movimiento TO kamayuk_readonly;
GRANT INSERT, SELECT ON edificacion_profesional TO kamayuk_app;
GRANT SELECT ON edificacion_profesional TO kamayuk_readonly;
GRANT INSERT, SELECT ON edificacion_proyecto TO kamayuk_app;
GRANT SELECT ON edificacion_proyecto TO kamayuk_readonly;
GRANT INSERT, SELECT ON edificacion_requisito TO kamayuk_app;
GRANT SELECT ON edificacion_requisito TO kamayuk_readonly;
GRANT INSERT, SELECT ON edificacion_terreno TO kamayuk_app;
GRANT SELECT ON edificacion_terreno TO kamayuk_readonly;
GRANT INSERT, SELECT ON edificacion_vigencia TO kamayuk_app;
GRANT SELECT ON edificacion_vigencia TO kamayuk_readonly;
GRANT INSERT, SELECT, UPDATE ON espectaculo TO kamayuk_app;
GRANT SELECT ON espectaculo TO kamayuk_readonly;
GRANT INSERT, SELECT ON expediente_coactivo TO kamayuk_app;
GRANT SELECT ON expediente_coactivo TO kamayuk_readonly;
GRANT INSERT, SELECT, UPDATE ON expediente_correlativo TO kamayuk_app;
GRANT SELECT ON expediente_correlativo TO kamayuk_readonly;
GRANT INSERT, SELECT ON expediente_movimiento TO kamayuk_app;
GRANT SELECT ON expediente_movimiento TO kamayuk_readonly;
GRANT INSERT, SELECT ON expediente_valor TO kamayuk_app;
GRANT SELECT ON expediente_valor TO kamayuk_readonly;
...
GRANT INSERT, SELECT ON internamiento TO kamayuk_app;
GRANT SELECT ON internamiento TO kamayuk_readonly;
GRANT INSERT, SELECT ON internamiento_movimiento TO kamayuk_app;
GRANT SELECT ON internamiento_movimiento TO kamayuk_readonly;
GRANT INSERT, SELECT, UPDATE ON licencia_correlativo TO kamayuk_app;
GRANT SELECT ON licencia_correlativo TO kamayuk_readonly;
GRANT INSERT, SELECT ON licencia_duplicado TO kamayuk_app;
GRANT SELECT ON licencia_duplicado TO kamayuk_readonly;
GRANT INSERT, SELECT ON licencia_edificacion TO kamayuk_app;
GRANT SELECT ON licencia_edificacion TO kamayuk_readonly;
GRANT INSERT, SELECT ON licencia_funcionamiento TO kamayuk_app;
GRANT SELECT ON licencia_funcionamiento TO kamayuk_readonly;
GRANT INSERT, SELECT, UPDATE ON licencia_giro TO kamayuk_app;
GRANT SELECT ON licencia_giro TO kamayuk_readonly;
GRANT INSERT, SELECT ON licencia_movimiento TO kamayuk_app;
GRANT SELECT ON licencia_movimiento TO kamayuk_readonly;
GRANT INSERT, SELECT, UPDATE ON liquidacion_correlativo TO kamayuk_app;
GRANT SELECT ON liquidacion_correlativo TO kamayuk_readonly;
GRANT INSERT, SELECT ON liquidacion_costas TO kamayuk_app;
GRANT SELECT ON liquidacion_costas TO kamayuk_readonly;
GRANT INSERT, SELECT, UPDATE ON liquidacion_costas_correlativo TO kamayuk_app;
GRANT SELECT ON liquidacion_costas_correlativo TO kamayuk_readonly;
GRANT INSERT, SELECT ON liquidacion_detalle TO kamayuk_app;
GRANT SELECT ON liquidacion_detalle TO kamayuk_readonly;
GRANT INSERT, SELECT ON liquidacion_fiscalizacion TO kamayuk_app;
GRANT SELECT ON liquidacion_fiscalizacion TO kamayuk_readonly;
GRANT INSERT, SELECT ON liquidacion_movimiento TO kamayuk_app;
GRANT SELECT ON liquidacion_movimiento TO kamayuk_readonly;
...
GRANT INSERT, SELECT ON notificacion TO kamayuk_app;
GRANT SELECT ON notificacion TO kamayuk_readonly;
GRANT INSERT, SELECT, UPDATE ON notificacion_administrativa TO kamayuk_app;
GRANT SELECT ON notificacion_administrativa TO kamayuk_readonly;
GRANT INSERT, SELECT, UPDATE ON otra_instalacion TO kamayuk_app;
GRANT SELECT ON otra_instalacion TO kamayuk_readonly;
GRANT INSERT, SELECT, UPDATE ON papeleta TO kamayuk_app;
GRANT SELECT ON papeleta TO kamayuk_readonly;
GRANT INSERT, SELECT ON papeleta_cambio_numero TO kamayuk_app;
GRANT SELECT ON papeleta_cambio_numero TO kamayuk_readonly;
GRANT INSERT, SELECT ON papeleta_masivo TO kamayuk_app;
GRANT SELECT ON papeleta_masivo TO kamayuk_readonly;
GRANT INSERT, SELECT, UPDATE ON papeleta_masivo_item TO kamayuk_app;
GRANT SELECT ON papeleta_masivo_item TO kamayuk_readonly;
...
GRANT INSERT, SELECT ON prescripcion TO kamayuk_app;
GRANT SELECT ON prescripcion TO kamayuk_readonly;
GRANT INSERT, SELECT ON prescripcion_ejercicio TO kamayuk_app;
GRANT SELECT ON prescripcion_ejercicio TO kamayuk_readonly;
GRANT INSERT, SELECT ON prescripcion_hecho TO kamayuk_app;
GRANT SELECT ON prescripcion_hecho TO kamayuk_readonly;
GRANT INSERT, SELECT, UPDATE ON programa_fiscalizacion TO kamayuk_app;
GRANT SELECT ON programa_fiscalizacion TO kamayuk_readonly;
GRANT INSERT, SELECT ON programa_muestra TO kamayuk_app;
GRANT SELECT ON programa_muestra TO kamayuk_readonly;
...
GRANT INSERT, SELECT ON resolucion_determinacion TO kamayuk_app;
GRANT SELECT ON resolucion_determinacion TO kamayuk_readonly;
GRANT INSERT, SELECT ON resolucion_gerencia TO kamayuk_app;
GRANT SELECT ON resolucion_gerencia TO kamayuk_readonly;
GRANT SELECT ON respaldo TO kamayuk_app;
GRANT SELECT ON respaldo TO kamayuk_readonly;
GRANT INSERT, SELECT, UPDATE ON responsable_solidario TO kamayuk_app;
GRANT SELECT ON responsable_solidario TO kamayuk_readonly;
GRANT INSERT, SELECT, UPDATE ON saldo_proyectado TO kamayuk_app;
GRANT SELECT ON saldo_proyectado TO kamayuk_readonly;
...
GRANT INSERT, SELECT, UPDATE ON transferencia TO kamayuk_app;
GRANT SELECT ON transferencia TO kamayuk_readonly;
GRANT INSERT, SELECT, UPDATE ON usuario TO kamayuk_app;
GRANT SELECT ON usuario TO kamayuk_readonly;
GRANT INSERT, SELECT, UPDATE ON valor TO kamayuk_app;
GRANT SELECT ON valor TO kamayuk_readonly;
GRANT INSERT, SELECT, UPDATE ON valor_correlativo TO kamayuk_app;
GRANT SELECT ON valor_correlativo TO kamayuk_readonly;
GRANT INSERT, SELECT, UPDATE ON valor_detalle TO kamayuk_app;
GRANT SELECT ON valor_detalle TO kamayuk_readonly;
GRANT INSERT, SELECT ON valor_masivo TO kamayuk_app;
GRANT SELECT ON valor_masivo TO kamayuk_readonly;
GRANT INSERT, SELECT, UPDATE ON valor_masivo_item TO kamayuk_app;
GRANT SELECT ON valor_masivo_item TO kamayuk_readonly;
GRANT INSERT, SELECT ON valor_movimiento TO kamayuk_app;
GRANT SELECT ON valor_movimiento TO kamayuk_readonly;
...
GRANT INSERT, SELECT, UPDATE ON vehiculo TO kamayuk_app;
GRANT SELECT ON vehiculo TO kamayuk_readonly;
...
COMMENT ON TABLE certificado IS 'Los certificados de numeracion, zonificacion y vias, parametros urbanisticos y jurisdiccion (#54, RF-115). SOLO SE AGREGA: se entrega al administrado, que se lo lleva, y uno equivocado se sustituye emitiendo otro -con su numero y su derecho de tramite-, nunca corrigiendo la fila. kamayuk_app no recibe UPDATE ni DELETE sobre esta tabla.';
