...
public record LicenciaResource(
        ...
        String zonaOrigen,
        @Nullable String comprobacionDelTerritorio,
    ...
    public static LicenciaResource de(ConsultaDeLicencias.LicenciaEnConsulta fila) {
        ...
        return new LicenciaResource(
                ...
                licencia.territorio().zonaDelTerritorio(),
                licencia.territorio().ordenanzaDeLaZona(),
                licencia.territorio().origen().name(),
                licencia.territorio().comprobacion(),
                licencia.territorio().autorizacion(),
                licencia.aforo(),
