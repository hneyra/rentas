 ...
 * titularidad} al 1 de enero del ejercicio, antes de las transferencias de ese dia (#328).
 * Admitirlo aqui dejaria inflar o desinflar la base del contribuyente desde la peticion, y la cifra
 * resultante seria indistinguible de la correcta.
 *
