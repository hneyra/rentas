...
import kamayuk.rentas.nucleo.dominio.CriterioDeBeneficio;
...
public class ConsultasDeRentas {
    ...
    private final kamayuk.rentas.nucleo.dominio.DeclaracionJuradaRepository declaraciones;
    ...
    public ConsultasDeRentas(
            ...
            kamayuk.rentas.nucleo.dominio.DeclaracionJuradaRepository declaraciones) {
    ...
    @Transactional(readOnly = true)
    public Optional<kamayuk.rentas.nucleo.dominio.DeclaracionJurada> declaracionPorNumero(
