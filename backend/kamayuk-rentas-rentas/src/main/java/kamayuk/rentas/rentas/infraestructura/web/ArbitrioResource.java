 ...
 *
 * <p>{@code monto} viaja como texto y no como {@link kamayuk.rentas.dominio.Dinero}: es la cifra
 * fija con que se determinó la cuota, no un saldo que cambie con el tiempo —igual que {@code
