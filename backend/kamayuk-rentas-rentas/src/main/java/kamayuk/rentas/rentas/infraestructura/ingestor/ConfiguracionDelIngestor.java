...
import kamayuk.rentas.rentas.aplicacion.AplicarUnHecho;
import kamayuk.rentas.rentas.aplicacion.IngestarHechosDeCatastro;
...
public class ConfiguracionDelIngestor {
    ...
    @Bean
    kamayuk.rentas.rentas.aplicacion.CorrerElIngestor correrElIngestor(
            IngestarHechosDeCatastro ingestor,
            @Value("${kamayuk.rentas.ingestor.municipalidad}") long municipalidadId) {
        return new kamayuk.rentas.rentas.aplicacion.CorrerElIngestor(ingestor, municipalidadId);
    }
