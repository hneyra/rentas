...
import kamayuk.rentas.rentas.aplicacion.ConsultaDeConciliacion.FichaConciliada;
import kamayuk.rentas.rentas.dominio.PlantillaDeNumeroDeDeclaracion;
import kamayuk.rentas.rentas.infraestructura.ConciliacionRepositoryJdbc;
import kamayuk.rentas.rentas.infraestructura.DeclaracionJuradaRepositoryJdbc;
import kamayuk.rentas.rentas.infraestructura.DeterminacionRepositoryJdbc;
import kamayuk.rentas.rentas.infraestructura.web.DeclaracionJuradaController;
...
class EscrituraDeDeclaracionJuradaJdbcTest {
                    ...
                    mvc.perform(
                                    org.springframework.test.web.servlet.request
                                            .MockMvcRequestBuilders.get(
                                                    "/rentas/api/v1/rentas/declaraciones/DJ-2026-999999/hoja")
                                            .param("ano", "2026"))
                            .andReturn();
    ...
    private static String hojaDe(String numero, @org.jspecify.annotations.Nullable String fecha)
        ...
        var peticion =
                org.springframework.test.web.servlet.request.MockMvcRequestBuilders.get(
                                "/rentas/api/v1/rentas/declaraciones/{djNro}/hoja", numero)
                        .param("ano", "2026");
        if (fecha != null) {
    ...
    private static MvcResult acto(String numero, String verbo, String observacion)
            throws Exception {
        return mvc.perform(
                        post("/rentas/api/v1/rentas/declaraciones/{djNro}/{verbo}", numero, verbo)
                                .param("ano", "2026")
                                .contentType(MediaType.APPLICATION_JSON)
