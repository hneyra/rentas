...
# corriendo el proceso batch CargarContribuyentesDeDemostracion (kamayuk-rentas-contribuyentes)
...
#        --archivo ejemplos/contribuyentes.csv [--namespace kamayuk-stg] [--observacion "..."]
#
...
SUFIJO=$(date +%s)
RECURSO="kamayuk-${AMBIENTE}-carga-demo-contribuyentes-${SUFIJO}"
            ...
            - name: KAMAYUK_DB_CLAVE
              valueFrom:
                secretKeyRef:
                  ...
                  key: clave-app
            - name: KAMAYUK_CARGACONTRIBUYENTESDEMO_MUNICIPALIDADID
              value: "$MUNICIPALIDAD_ID"
            - name: KAMAYUK_CARGACONTRIBUYENTESDEMO_ARCHIVO
              value: /datos/contribuyentes.csv
            - name: KAMAYUK_CARGACONTRIBUYENTESDEMO_USUARIODELPROCESO
              value: carga-demostracion
            - name: KAMAYUK_CARGACONTRIBUYENTESDEMO_OBSERVACION
              value: "$OBSERVACION"
          volumeMounts:
            - name: datos
              mountPath: /datos
